...
- **Linux**: nerdctl-full is bundled inside the .deb package. No additional system package manager dependency is required — the user installs the package and everything is included. See ADR-003 and ADR-021 for details. (See ADR-025)
