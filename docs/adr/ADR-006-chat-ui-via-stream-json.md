...
[^3]: Claude Agent SDK streaming output: `stream_event` messages wrapping raw Anthropic Messages API events (`content_block_start`, `content_block_delta`, `content_block_stop`, `message_delta`, `message_stop`). https://code.claude.com/docs/en/agent-sdk/streaming-output
