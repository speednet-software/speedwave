...
| [ADR-079](ADR-079-wsl2-mirrored-container-host-relay.md)               | Container↔host relay for WSL2 mirrored networking — loopback bind + guest-side socat relay so containers reach host bridges | Accepted                      |
