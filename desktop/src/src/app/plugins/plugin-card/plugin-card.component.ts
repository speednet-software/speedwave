    ...
    >
      <div class="flex justify-between items-center px-5 py-4">
        ...
        <div class="flex items-center gap-3">
          <button
            type="button"
            class="px-3 py-1 bg-transparent text-sw-accent border border-sw-accent rounded text-xs font-mono cursor-pointer transition-all duration-200 hover:bg-sw-accent hover:text-on-accent"
