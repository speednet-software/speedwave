...
const markdownToDocxTool: Tool = {
  ...
  annotations: WRITE_ANNOTATIONS,
  _meta: DEFERRED,
  keywords: ['markdown', 'docx', 'word', 'document', 'convert', 'export'],
  inputSchema: {
    type: 'object',
    properties: {
...
const markdownToPptxTool: Tool = {
  ...
  annotations: WRITE_ANNOTATIONS,
  _meta: DEFERRED,
  keywords: ['markdown', 'pptx', 'powerpoint', 'slides', 'presentation', 'convert', 'export'],
  inputSchema: {
    type: 'object',
    properties: {
      input: { type: 'object', description: '{ path } or { markdown }' },
...
const editDocxTool: Tool = {
  ...
  annotations: WRITE_ANNOTATIONS,
  _meta: DEFERRED,
  keywords: ['docx', 'word', 'edit', 'modify', 'update', 'replace', 'append'],
  inputSchema: {
    type: 'object',
    properties: {
...
const editXlsxTool: Tool = {
  ...
  annotations: WRITE_ANNOTATIONS,
  _meta: DEFERRED,
  keywords: ['xlsx', 'excel', 'edit', 'modify', 'cell', 'formula', 'sheet', 'chart'],
  inputSchema: {
    type: 'object',
    properties: {
...
const createPptxTool: Tool = {
  ...
  annotations: WRITE_ANNOTATIONS,
  _meta: DEFERRED,
  keywords: ['pptx', 'powerpoint', 'slides', 'presentation', 'create', 'chart', 'deck', 'generate'],
  inputSchema: {
    type: 'object',
...
const editPptxTool: Tool = {
  ...
  annotations: WRITE_ANNOTATIONS,
  _meta: DEFERRED,
  keywords: ['pptx', 'powerpoint', 'edit', 'modify', 'slide', 'deck'],
  inputSchema: {
    type: 'object',
    properties: {
