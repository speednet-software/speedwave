/**
 * Shared tool-handler error wrapping: run a Redmine operation and format any
 * thrown error via RedmineClient.formatError with structured context.
 */
...
/**
 * Run a Redmine tool handler body, converting a thrown error into a formatted errorResult.
