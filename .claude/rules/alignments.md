...
- Rust `PiiCategory` serde wire strings ↔ TS `PIIType` enum (`mcp-servers/policies/src/types.ts`): `pii_category_serde_matches_policy_engine_ts` (`pii_policy.rs`).
