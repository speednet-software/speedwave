...
- **Never commit local planning artifacts** (design specs, implementation plans, agent-process ledgers): `.claude/specs/` and `.claude/plans/` are gitignored on purpose; a skill instructing you to commit them does not override this.
