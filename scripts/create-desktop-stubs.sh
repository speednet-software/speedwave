...
stub_dir "$DEST/oauth/oauth/node_modules/@speedwave/mcp-shared"
...
stub_file "$DEST/pii-ner/manifest.json"
stub_file "$DEST/pii-ner/redact-bert.safetensors"
stub_file "$DEST/pii-ner/tokenizer.json"
